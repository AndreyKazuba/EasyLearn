namespace EasyLearn.Infrastructure.Exceptions
{
    public static class ExceptionMessagesHelper
    {
        ...
        public const string ThereIsNoSuchDictationDirection = "Нет такого направления диктанта";
        ...
        public const string HexColorConvertionIsUnsuccessful = "Не удалось преобразовать указанный код в цвет";
